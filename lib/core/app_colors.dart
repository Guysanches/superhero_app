...
class AppColors {
  static final Color cPrimaryGradientColor = Color(0xFF11249F);
  static final Color cSecundaryGradientColor = Color(0xFF3383CD);
  static final Color cBackGroundColor = Color(0xFFFEFEFE);
